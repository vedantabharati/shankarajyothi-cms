...
export const metadata = { title: 'Ludhiana | Shankarajyothi', description: 'Ludhiana — Punjab, industrial and cultural city.' }
  ...
  return (
    <>
      <section className="location-hero">
        ...
        <p className="location-desc">Punjab&apos;s largest city — an industrial and cultural hub on the banks of the Sutlej river, en route to Amritsar.</p>
