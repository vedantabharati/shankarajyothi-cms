...
export const metadata = { title: 'Junagadh | Shankarajyothi', description: 'Junagadh — Khapra Kodiya Caves and Girnar Hills.' }
...
export default async function JunagadhPage() {
  ...
  const placesOfInterest = [
    { icon: '🗿', name: 'Khapra Kodiya Caves', desc: 'Ancient Buddhist rock-cut caves near Junagadh, dating to the 3rd–4th century CE, showcasing early monastic architecture.' },
    { icon: '⛰️', name: 'Girnar Hills', desc: 'A sacred mountain with over 800 temples, including the Neminath Jain temple. The Ashoka rock edicts at its base date to the 3rd century BCE.' },
  ]
  return (
    <>
      <section className="location-hero">
        ...
        <p className="location-desc">A city of ancient heritage at the foot of Mount Girnar — home to rock-cut caves and centuries of pilgrimage tradition.</p>
