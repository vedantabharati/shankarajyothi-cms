...
export interface Location {
  ...
  plaqueInstalled?: boolean | null;
  /**
   * This will be the unique part of the URL the QR code points to (e.g., kanchi-kamakoti).
   */
  qrSlug?: string | null;
  images?: (number | Media)[] | null;
  /**
   * The numeric ID printed on the physical QR plaque (e.g., 102).
   */
...
export interface Expedition {
  ...
  /**
   * Add locations with their arrival and departure dates in order.
   */
  itinerary?:
    | {
